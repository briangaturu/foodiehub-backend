...
import { createUserServices, getUserByEmailService, updateUserPasswordService } from "./auth.services";
...
export const createUser = async (req: Request, res: Response) => {     
    try {
        ...
        const result = await sendNotificationEmail(user.email, "account created successfully", "Welcome to our food services", "Your account has been created successfully.");    
